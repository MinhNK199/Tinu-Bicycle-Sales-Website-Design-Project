...
<!-- Mirrored from themestore.sosnok.com/html/dotbike-preview/dotbike/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Nov 2024 16:18:56 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>DotBike | Home2 Box</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Place favicon.ico in the root directory -->
    <link href="img/apple-touch-icon.png" type="assets/img/x-icon" rel="shortcut icon">
                            ...
                            <div class="mini-cart">
                                ...
                                <ul class="cart-area">
                                    <li class="single-cart">
                                        <div class="cart-img"><img src="assets/img/cart/cart1.png" alt=""></div>
                                        <div class="cart-content">
                                            <h4><a href="#">Mountain Bike <br/> Name Here</a></h4>
                                            <p>$122.00</p>
                                        </div>
                                        <div class="cart-del">
                                ...
                                <div class="main-menu hidden-sm hidden-xs">
                                    <nav>
                                        <ul>
                                            ...
                                            <li class="mega_parent"><a href="#">Bikes & Frames</a>
                                                <ul class="mega-menu">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="grid-view">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="single-product text-center">
                                        <div class="single-product-inner">
                                            <div class="product-img">
                                                <a href="#"><img src="assets/img/product/7.png" alt=""></a>
                                            </div>
                                            <div class="product-details">
