                        ...
                        <div class="col">
                            ...
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Thêm Tin Tức</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="live-preview">
                                        <form action="?act=them-tin-tuc" method="POST">
                                            <div class="row">
                                                
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="citynameInput" class="form-label">Tên Tiêu đề</label>
                                                        <input type="text" class="form-control" placeholder="Nhap tieu de cho tin  tuc" name="tieu_de">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhap noi dung" name="noi_dung">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" id="ForminputDate" class="form-control" name="ngay_dang">
                                                        <span class="text-danger">
