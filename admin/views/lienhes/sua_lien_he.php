                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhap tieu de cho tin  tuc" name="email" value="<?= $lienHe['email'] ?>">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhap noi dung" name="noi_dung" value="<?= $lienHe['noi_dung'] ?>">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="ForminputDate" class="form-label">Ngày tạo</label>
                                                        <input type="date" id="ForminputDate" class="form-control" name="ngay_tao" value="<?= $lienHe['ngay_tao'] ?>">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select id="ForminputStatus" class="form-select" name="trang_thai">
                                                            ...
                                                            <option value="1" <?= $lienHe['trang_thai'] == 1 ? 'selected' :'' ?>>Hiển thị</option>
                                                            <option value="2" <?= $lienHe['trang_thai'] == 2 ? 'selected' :'' ?>>Không hiển thị</option>
                                                        </select>
                                                        <span class="text-danger">
