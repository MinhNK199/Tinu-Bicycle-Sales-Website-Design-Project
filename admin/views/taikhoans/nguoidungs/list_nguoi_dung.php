                        ...
                        <div class="col">
                            ...
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    ...
                                    <a href= "?act=form-add-nguoi-dung" class="btn btn-soft-success material-shadow-none"><i class="ri-add-circle-line align-middle me-1"></i> Them Tai khoan</a>
                                    ...
                                    <div class="live-preview">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-nowrap align-middle mb-0">
                                                ...
                                                <tbody><?php foreach ($nguoiDungs as $index => $nguoiDung) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                                    ...
                                                                    <div class="hstack gap-3 flex-wrap">
                                                                        ...
                                                                        <a href="?act=form-sua-nguoi-dung&nguoi_dung_id=<?= $nguoiDung['id'] ?>" class="link-success fs-15"><i class="ri-edit-2-line"></i></a>
                                                                        <a href="<?='?act=resset-password&nguoi_dung_id='. $nguoiDung['id'] ?>"
