                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="live-preview">
                                            <form action="?act=sua-khuyen-mai" method="POST" onsubmit="return setStatus()">
                                                 <input type="hidden" name = "id" value = "<?= $khuyenMai['id']?>">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="citynameInput" class="form-label">Tên Khuyến Mãi</label>
                                                            <input type="text" class="form-control" placeholder="Nhap tên khuyến mãi" name="ten_khuyen_mai" value="<?= $khuyenMai['ten_khuyen_mai'] ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Nhap gia tri" name="gia_tri" value="<?= $khuyenMai['gia_tri'] ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" id="ngay_bat_dau" class="form-control" name="ngay_bat_dau" value="<?= $khuyenMai['ngay_bat_dau'] ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" id="ngay_ket_thuc" class="form-control" name="ngay_ket_thuc" value="<?= $khuyenMai['ngay_ket_thuc'] ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Nhap mo ta" name="mo_ta" value="<?= $khuyenMai['mo_ta'] ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="hidden" id="trang_thai" name="trang_thai" value="<?= $khuyenMai['trang_thai'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="text-left">
